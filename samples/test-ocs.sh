...
do
	...
	echo
	oc get cephcluster --namespace openshift-storage 2>&1 | tee -a $WORKSPACE/test-ocs-ci.log
	echo
	oc get pods --namespace openshift-storage 2>&1 | tee -a $WORKSPACE/test-ocs-ci.log
	set -e
done
