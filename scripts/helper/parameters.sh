...
GO_VERSION=${GO_VERSION:="go1.20.5"}
TERRAFORM_VERSION=${TERRAFORM_VERSION:="v1.2.7"}
TERRAFORM_RANDOM_VERSION=${TERRAFORM_RANDOM_VERSION:="3.4"}
TERRAFORM_NULL_VERSION=${TERRAFORM_NULL_VERSION:="3.2"}
TERRAFORM_IGNITION_VERSION=${TERRAFORM_IGNITION_VERSION:="2.1.2"}
TERRAFORM_IGNITION_LEGACY_VERSION=${TERRAFORM_IGNITION_LEGACY_VERSION:="1.2.1"}
TERRAFORM_POWERVS_VERSION=${TERRAFORM_POWERVS_VERSION:="1.52.0"}
TERRAFORM_OPENSTACK_VERSION=${TERRAFORM_OPENSTACK_VERSION:="1.50.0"}
